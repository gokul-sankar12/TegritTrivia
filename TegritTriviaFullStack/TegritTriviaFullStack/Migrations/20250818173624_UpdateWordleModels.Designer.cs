...
namespace TegritTriviaFullStack.Migrations
{
    ...
    [Migration("20250818173624_UpdateWordleModels")]
    partial class UpdateWordleModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TegritTriviaFullStack.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<long>("NumPerfectScores")
                    ...
                    b.Property<long>("QuizzesSubmitted")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TegritTriviaFullStack.Models.UserQuiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TegritTriviaFullStack.Models.UserWordle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UserSubmissions")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("WordleCompleted")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("UserWordle");
                });

            modelBuilder.Entity("TegritTriviaFullStack.Models.ValidWords", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TegritTriviaFullStack.Models.Wordle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TegritTriviaFullStack.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TegritTriviaFullStack.Models.UserQuiz", b =>
                {
                    ...
                    b.HasOne("TegritTriviaFullStack.Data.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
