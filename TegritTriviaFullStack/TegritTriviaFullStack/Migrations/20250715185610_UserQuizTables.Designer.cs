...
namespace TegritTriviaFullStack.Migrations
{
    ...
    [Migration("20250715185610_UserQuizTables")]
    partial class UserQuizTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TegritTriviaFullStack.Models.UserAnswers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TegritTriviaFullStack.Models.UserAnswers", b =>
                {
                    b.HasOne("TegritTrivia.Models.TriviaResults", "TriviaResult")
                        .WithMany()
                        .HasForeignKey("TriviaResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TegritTriviaFullStack.Models.UserQuiz", null)
                        .WithMany("UserAnswers")
                        .HasForeignKey("UserQuizId");

                    b.Navigation("TriviaResult");
                });
